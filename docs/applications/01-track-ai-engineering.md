...
**Evidence:** 148-repo system with automated governance, 2,349 tests across flagship projects, 5 CI/CD governance workflows, ~6K+ words of documentation
...
"I designed and implemented an eight-organ orchestration system coordinating 148 repos across 8 orgs with automated governance, dependency validation, and health checks."
...
5. **Documents thoroughly** — ~6K+ words of documentation is evidence of communication capacity
...
- "The dependency validation ensures no circular dependencies across 148 repos — the same kind of constraint enforcement that matters in AI safety"
...
**Why you fit:** These companies need people who can bridge technical depth with clear communication. Your ~6K+ words of documentation + working systems = evidence of both.
...
>
> The eight-organ system I designed coordinates 148 repositories across 8 GitHub organizations. The system includes:
>
...
> - ~6K+ words of documentation across the entire system
>
...
A: 148 repositories across 8 GitHub organizations, coordinated by a machine-readable registry, automated dependency validation, and a promotion state machine. Walk through the architectural decisions: why 8 organs (domain separation), why a state machine (governance without human bottlenecks), why dependency validation (structural integrity at scale).

Q: "How do you handle system failures?"
A: organ-audit.py runs monthly health checks across all 148 repos. governance-rules.json defines critical vs. warning thresholds. The validate-dependencies workflow blocks merges that would violate constraints. 0 critical alerts since launch.
