# Submission Script — Tulsa Artist Fellowship

**Created:** 2026-02-18
**Time to complete:** ~30-45 minutes
**URL:** https://tulsaartistfellowship.org/
**Deadline:** Spring 2026 app
**Award:** $230,000+ (3 years: $150K + housing + healthcare)
**Identity position:** Systems Artist (secondary: Community Practitioner)
**Benefits cliff:** $230K+ over 3 years. Full benefits exit. But salary is substantial.

---

> This is a step-by-step paste-and-submit guide. All answers are pre-written.
> Identity framing: **Systems Artist** — I build creative systems — the governance IS the artwork.

---

## Pre-flight (3 minutes)

- [ ] Open application: https://tulsaartistfellowship.org/
...
Tulsa Artist Fellowship aligns precisely with the trajectory of this practice — the combination of creative rigor, technical depth, and public documentation that defines the eight-organ methodology.
...
### Sample 2: Eight-Organ System Hub
...
- [ ] Update status: `tulsa-fellowship` → SUBMITTED
