# Submission Script — Awesome Foundation NYC
...
**Deadline:** Monthly
**Award:** $1,000
**Identity position:** Systems Artist (secondary: None)
...
- [ ] Open application: https://www.awesomefoundation.org/en/chapters/nyc
...
Awesome Foundation NYC represents a critical opportunity to sustain and extend this practice. The work is built, documented, and operational — what it needs now is the time and resources to deepen, not to start over.
...
- [ ] Update status: `awesome-foundation` → SUBMITTED
