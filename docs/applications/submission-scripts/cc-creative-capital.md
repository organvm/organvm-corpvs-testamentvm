# Submission Script — Creative Capital 2027 Open Call
...
- [ ] Open application: https://creative-capital.org/creative-capital-award/award-application/
...
Creative Capital 2027 Open Call represents a critical opportunity to sustain and extend this practice. The work is built, documented, and operational — what it needs now is the time and resources to deepen, not to start over.
...
- [ ] Update status: `creative-capital` → SUBMITTED
