# Submission Script — Stimpunks Creator Grant

**Created:** 2026-02-18
**Time to complete:** ~30-45 minutes
**URL:** https://stimpunks.org/creators/grant/
**Deadline:** Rolling (5 grants/year)
**Award:** $3,000
...
- [ ] Open application: https://stimpunks.org/creators/grant/
...
- [ ] Update status: `stimpunks` → SUBMITTED
