# Submission Script — Pioneer Works Residency

**Created:** 2026-02-18
**Time to complete:** ~30-45 minutes
**URL:** https://pioneerworks.org/
**Deadline:** Summer 2026 for 2027
**Award:** $1,000-$2,500 + studio
**Identity position:** Systems Artist (secondary: Community Practitioner)
**Benefits cliff:** Small stipend. SNAP-safe.
...
- [ ] Open application: https://pioneerworks.org/
...
A residency at Pioneer Works Residency would provide the focused time and creative community to advance the most challenging next phase of this work — moving from documented infrastructure to active community engagement and public presentation.
...
- [ ] Update status: `pioneer-works` → SUBMITTED
