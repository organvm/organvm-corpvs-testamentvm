...
**Evaluation infrastructure as a first-class concern.** I built organ-audit.py (monthly health monitoring across 150 repos), platinum-validation.py (full system sweep against 1,267 audited links and 63 dependency edges), and 5 GitHub Actions workflows that enforce governance continuously. Evaluation framework building isn't a secondary skill — it's central to how I design systems.
