...
| Documentation at scale | ~6K+ words, every README portfolio-quality |
...
**Why this fits:**
- Passion for developer tools demonstrated by building orchestration-start-here as entry point to 150-repo system
...
- Evaluation framework building = what platinum-validation.py does across 150 repos
...
- ~6K+ words of portfolio-quality documentation IS the portfolio for this role
...
**Why this fits:**
- **This is the single strongest documentation match.** Founding team member for documentation. ~6K+ words of documentation is the portfolio.
...
- Customer-facing dimension requires documentation/communication skills — ~6K+ words
