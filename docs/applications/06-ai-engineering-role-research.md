...
| Documentation at scale | ~882K+ words, every README portfolio-quality |
...
- Forward-deployed model values someone who can represent the company at the highest technical level while communicating clearly — ~882K+ words of documentation proves this
...
- ~882K+ words of portfolio-quality documentation IS the portfolio for this role
...
**Why this fits:**
- **This is the single strongest documentation match.** Founding team member for documentation. ~882K+ words of documentation is the portfolio.
...
- Customer-facing dimension requires documentation/communication skills — ~882K+ words
