...
- The governance corpus (~882K+ words) is evidence of capability
...
- The governance corpus (~882K+ words), the registry, the schemas
...
| Documentation volume | ~882K+ words | system metrics |
