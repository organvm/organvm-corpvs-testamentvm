...
| Agent Handoff: persona-fleet — Task 25 | _root | create_file |
| Plan: persona-fleet Task 26 — identity primitives  | _root | generic |
| Decision Framework — Protocol → Precedent → Consti | _root | verify |
| Patient-capital plays: 90-180 day horizon, zero ca | _root | delete_file |
